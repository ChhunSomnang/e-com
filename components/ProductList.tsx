  ...
  return (
    <div className=" mt-12 flex gap-x-8 gap-y-16 justify-between flex-wrap">
      ...
      <div className="relative w-full h-80">
        ...
        />
        <Image
          src="https://images.pexels.com/photos/27255525/pexels-photo-27255525/free-photo-of-back-lit-shot-of-a-woman-in-a-white-dress.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
          alt=""
          fill
          sizes="25vw"
